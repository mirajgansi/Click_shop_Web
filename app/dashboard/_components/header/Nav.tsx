    ...
    <nav className="hidden md:flex items-center gap-8">
      ...
      <div className="relative group">
        ...
        <div className="absolute left-0 top-full mt-2 w-48 bg-white rounded-xl shadow-lg opacity-0 group-hover:opacity-100 invisible group-hover:visible transition">
          <Link href="/category/fruits" className="block px-4 py-2 hover:bg-gray-100">
            Fruits
          </Link>
          <Link href="/category/vegetables" className="block px-4 py-2 hover:bg-gray-100">
            Vegetables
          </Link>
          <Link href="/category/snacks" className="block px-4 py-2 hover:bg-gray-100">
            Snacks
          </Link>
        </div>
      </div>
